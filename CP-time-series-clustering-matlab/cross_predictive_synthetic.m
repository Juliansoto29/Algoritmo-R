%% synthetic experiments for cross-predictive high dimensional clustering
...
res1 = []; %violation rate over runs
res2 = []; %rand index over runs
k = 15; % # of clusters
%for k = 5:5:25 %# of clusters
for alpha = 0.8:0.2:0.8 % spectral norm of A
